...
Quantum field theory describes how particles and fields behave at the smallest scales, but traditional methods can obscure the fundamental principle of causality: that effects must follow their causes. This thesis develops new mathematical techniques that keep causality explicit throughout calculations, making the physics clearer and potentially easier to simulate on quantum computers.

We apply this framework to two striking phenomena. First, the Unruh effect: the prediction that an accelerating observer perceives empty space as a warm bath of particles. Second, the physics of black holes, where quantum effects near the event horizon produce Hawking radiation. In both cases, our causal approach reproduces the same physical answers as traditional methods, but with the underlying causality made transparent. The thesis also introduces new diagrammatic tools, analogous to the famous Feynman diagrams but operating at the probability level, that may simplify future calculations and make quantum field theory more amenable to simulation on quantum computers.
