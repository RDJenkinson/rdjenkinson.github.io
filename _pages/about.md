...
My work focuses on understanding quantum information in relativistic settings and developing theoretical frameworks that bridge fundamental physics with practical quantum technologies. Key areas include:

- **Qubit simulations of quantum field theory**: Developing methods to simulate QFT phenomena on quantum computers
- **Causality in quantum field theory**: Exploring manifestly causal approaches to QFT calculations
- **Quantum field theory in curved spacetime**: Understanding how quantum fields behave in gravitational backgrounds
...
I'm always interested in collaborating across quantum information, high-energy theory, and related areas. If you think our interests might overlap, or if you'd like to discuss quantum field theory, quantum computing, or the intersection of fundamental physics with quantum technologies, feel free to reach out.
